<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="WebApplication3.WebForms.WebForm1" %>
            ...
            <tr style="border: thin;">
                <td style="border-top: solid; height: 290px; background-color: white; border-end-start-radius: 18px; border-end-end-radius: 18px;" class="auto-style4">
                    ...
                    <form id="form1" runat="server">
                        ...
                        <asp:TextBox name="TextBox1" type="text" ID="TextBox1" runat="server" placeholder="Entre su Usuario" Style="height: 31px; width: 265px; font-size: 24px; font-family: Bree serif;" OnTextChanged="TextBox1_TextChanged"> </asp:TextBox>
