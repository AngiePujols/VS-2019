        ...
        <div class="cuerpo">
            ...
            <p class="auto-style2">
                <asp:DropDownList ID="DropCuenta" runat="server" Font-Bold="True" style="margin-left: 0px" Width="212px" CssClass="auto-style4" OnSelectedIndexChanged="DropCuenta_SelectedIndexChanged">
                    ...
                    <asp:ListItem>100315</asp:ListItem>
                    <asp:ListItem>100453</asp:ListItem>
                    <asp:ListItem>104535</asp:ListItem>
                    <asp:ListItem>100342</asp:ListItem>
                    <asp:ListItem>103455</asp:ListItem>
                    <asp:ListItem>134525</asp:ListItem>
                    <asp:ListItem>100975</asp:ListItem>
                    <asp:ListItem>102349</asp:ListItem>
                    <asp:ListItem>123492</asp:ListItem>
                    <asp:ListItem>132457</asp:ListItem>
